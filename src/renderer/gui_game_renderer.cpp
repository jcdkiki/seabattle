...
namespace seabattle {
    ...
    static constexpr rgba32 DOUBLEDAMAGE_COLOR(255, 127, 127, 63);
    static constexpr rgba32 SCANNER_COLOR(127, 127, 255, 63);
    static constexpr rgba32 SNEAKY_ATTACK_COLOR(127, 255, 127, 63);
